...
import { getQiniuUpToken, selectImgFiles, changeImgBase64 } from '/ducks'
...
class ImgCard extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <label htmlFor='addImg' style={{ height: '80px', width: '80px', backgroundImage: `url(${doctorImg})`, backgroundSize: 46, display: 'block' }} />
        <input type='file' accept='image/*' id='addImg' style={{ display: 'none' }} onChange={e => this.clickDescribeAddImg(e)} />
      </div>
    )
  }
}
...
export default connect(mapStateToProps, { getQiniuUpToken, selectImgFiles, changeImgBase64 })(ImgCard)
