      ...
      <div style={{backgroundColor: '#ffffff'}} key={data.id}>
        <div
          ...
          <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', backgroundColor: '#ffffff', padding: '10px 15px'}}>
            ...
            <div style={{flex: 1}} />
            <div style={{color: '#555', fontSize: 16}}><span style={{marginRight: 6}}>{data.chargeTotal}</span>{!this.state.open ? <span style={{padding: '0', display: 'inline-block', transform: 'rotate(45deg)'}} className='back-left'></span> : <span style={{padding: '0', display: 'inline-block', transform: 'rotate(225deg)'}} className='back-left'></span>}</div>
          </div>
        </div>
        <div style={{backgroundColor: '#E6E6E6', height: 1}} />
...
const contentListItem = (data) => {
  return (
    <div style={{padding: '0px 15px'}}>
      ...
      <div style={{flexDirection: 'row', padding: '10px 15px', display: 'flex'}}>
