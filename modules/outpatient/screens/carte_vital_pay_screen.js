...
class CarteVitalPayScreen extends Component {
  constructor (props) {
    super(props)
    this.state = {
      closeTime: 2,
    ...
    return (
      <div>
        <div>
          ...
          <div className='item'>
            <div className='label'>医保卡</div>
            <div className='text'>{outpatient.carte_vital}</div>
          </div>
...
export default connect(mapStateToProps, {queryOutpatientDetail, selectOutpatient})(CarteVitalPayScreen)
