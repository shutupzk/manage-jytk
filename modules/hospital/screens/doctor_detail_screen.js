  ...
  render () {
    ...
    return (
      <div className='container' style={styles.container}>
        {
          this.renderTitleCard(doctor)
        }
        {
          this.renderMajor(doctor)
        }
        {
          this.renderSchedule(doctor)
        }
        {
          this.renderDescription(doctor)
        }
        {
          this.renderAwards(doctor)
        }
        {
          this.renderBottomButton(doctor)
        }
      </div>
    )
  }
