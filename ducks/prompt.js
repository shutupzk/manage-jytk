...
export function prompt (state = initState, action = {}) {
  switch (action.type) {
    case PROMPT_SHOW:
      return Object.assign({}, state, { data: { text: action.text, timer: action.timer || 2000 } }, { loading: false, error: null })
    case PROMPT_HIDE:
      return Object.assign({}, state, { data: { text: '', timer: null } }, { loading: false, error: null })
    default:
      return state
  }
}
