...
export function doctor (state = initState, action = {}) {
  ...
  switch (action.type) {
    ...
    case UPDATE_DOCTOR_INFO_SUCCESS:
      return Object.assign({}, state, { data: action.doctor }, { loading: false, error: null })
    case DOCTOR_SELECT_DOCTOR:
      return Object.assign({}, state, Object.assign({}, state.data, { selectedDoctor: action.data }))
    default:
      return state
  }
}
...
const QUERY_DOCTORS = gql`
  query($skip: Int, $limit: Int, $keyword: String, $quikeOpen: Boolean, $imageAndTextOpen: Boolean, $videoOpen: Boolean) {
  ...
  mutation(
    ...
    updateDoctor(
      ...
      input: {
        ...
        quikeOpen: $quikeOpen
        imageAndTextOpen: $imageAndTextOpen
        videoOpen: $videoOpen
        quikePrice: $quikePrice
        imageAndTextPrice: $imageAndTextPrice
