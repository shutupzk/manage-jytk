...
const HOME_PAGE = { // 泰康仙林
  ...
  grid_module: [
    {title: '预约挂号', avatar: '../static/xianlin/homeAppoint.png', subTitle: '', navigateName: '/appointment/department_list'},
    {title: '门诊缴费', avatar: '../static/xianlin/homeoutpatient.png', subTitle: '', navigateName: '/outpatient/order_type'},
    {title: '查询报告', avatar: '../static/xianlin/homeReport.png', subTitle: '', navigateName: '/report'},
    {title: '疾病自查', avatar: '../static/xianlin/homeSelf.png', subTitle: '', navigateName: '/diagnosis'},
    {title: '住院跟踪', avatar: '../static/xianlin/homeInhos.png', subTitle: '', navigateName: '/inpatient'}
  ],
  hospital: {
